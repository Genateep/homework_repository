...
def test_get_longest_diverse_words(get_longest_diverse_words):
...
def test_get_rarest_char(get_rarest_char):
...
def test_count_punctuation_chars(count_punctuation_chars):
...
def test_count_non_ascii_chars(count_non_ascii_chars):
...
def test_get_most_common_non_ascii_char(get_most_common_non_ascii_char):
