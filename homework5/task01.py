...
class Student:
    ...
    def do_homework(homework: Homework) -> Homework or None:
        """Returns Homework if deadline is True else prints 'Too late, bro'."""
        return homework if homework.is_active() else print("Too late, bro")
